  ...
  return (
    <div className=''>
      ...
      <div className="h-[100vh] grid grid-cols-2">
        <NavLink to="/">
          <div
            className="relative h-full bg-cover bg-[center_30]"
            style={{
              backgroundImage:
          ...
          >
            <div className="absolute top-[80%] left-[20%] -translate-x-1/2 bg-white flex items-center shadow">
              <span className="px-3 py-1 font-medium">₹1999</span>
        ...
        <NavLink to="/">
          <div
            className="relative h-full bg-cover bg-[center_25%]"
            style={{
              backgroundImage:
      ...
      <div className='h-[80vh] relative'>
          <div className='bg-[url("https://cdn.myportfolio.com/71bdbafa5b127e2fc9138c11dcef5391/d43fc9b8-571d-4769-85c1-c7d8098d5e5b.jpg?h=c527c5a5c9c0955db43760e3387ac4e2")] w-full h-full bg-no-repeat bg-cover bg-[center_55%] flex items-center justify-center flex-col'>
