  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col md:flex-row w-full min-h-[60vh]">
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-14 py-14 gap-6 bg-white">
          <Reveal>
            <p className="font-michroma text-xs tracking-[0.3em] text-gray-400 uppercase mb-1">2026 Season</p>
            <h2 className="font-montserrat text-3xl md:text-5xl font-semibold leading-none mb-2">/ THE PURSUIT</h2>
            <h2 className="font-montserrat text-3xl md:text-5xl font-light leading-none text-gray-400">of Essential Form.</h2>
          </Reveal>
        </div>

        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-14 py-14 gap-5 bg-[#f7f7f5]">
          <Reveal delay={0.12}>
            <p className="font-montserrat text-[13px] text-gray-600 leading-[1.9] mb-4">
            ...
            <p className="font-montserrat text-[13px] text-gray-500 leading-[1.9] mb-6">
            ...
            <a href="#" className="font-montserrat text-xs tracking-widest uppercase text-gray-800 underline underline-offset-4 hover:opacity-60 transition-opacity duration-200 w-fit">
              Read the Journal
            </a>
          </Reveal>
        </div>
      ...
      <div className="flex flex-col md:flex-row w-full md:h-[100vh]">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-14 py-14 gap-6 bg-[#f7f7f5]">
          <Reveal>
            <p className="font-michroma text-xs tracking-[0.3em] uppercase text-gray-400 mb-2">Craft</p>
            <h2 className="font-montserrat text-2xl md:text-4xl font-semibold leading-snug mb-4">
              The Materiality
              <br />
              <span className="font-light text-gray-400">of Time.</span>
            </h2>
            <p className="font-montserrat text-[13px] text-gray-500 leading-[1.9] max-w-sm mb-6">
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                <li key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-montserrat text-[11px] font-bold uppercase tracking-widest text-gray-900 leading-none mb-1">{label}</p>
                    <p className="font-montserrat text-xs text-gray-500 leading-relaxed">{desc}</p>
                  </div>
                </li>
              ))}
            </ul>
      ...
      <div className="px-6 md:px-10 py-12 grid grid-cols-1 md:grid-cols-3 gap-5">
        {manifestoCards.map(({ bg, img, label, heading, sub, cta }, i) => (
          <Reveal key={heading} delay={i * 0.1}>
            <div
              className="relative flex flex-col md:flex-row items-stretch rounded-2xl overflow-hidden min-h-[280px] cursor-pointer group"
              style={{ backgroundColor: bg }}
            >
              <div className="flex flex-col gap-3 px-7 py-8 z-10 md:max-w-[58%]">
                <p className="font-michroma text-[9px] tracking-[0.3em] uppercase text-gray-500">{label}</p>
                <h3 className="font-montserrat text-lg md:text-xl font-semibold leading-snug text-gray-900">{heading}</h3>
                <p className="font-montserrat text-xs text-gray-500 leading-relaxed">{sub}</p>
